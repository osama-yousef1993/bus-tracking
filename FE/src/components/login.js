...
const Login = () => {
  ...
  return (
    <Box sx={{ 
      ...
      {/* TOP WHITE SECTION */}
      <Box sx={{ flex: '0 0 50vh', p: 2, display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ 
        ...
        <Paper elevation={0} sx={{ 
          ...
          <Typography variant="h5" sx={{ color: brandBlue, fontWeight: 'bold', mb: 4 }}>
            Login
          </Typography>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 1, px: 1 }}>
            <Link href="#" sx={{ fontSize: '0.85rem', color: brandBlue, textDecoration: 'none' }}>
              Forgot password?
            </Link>
            <Link 
              component={RouterLink} 
              to="/register" 
              sx={{ fontSize: '0.85rem', color: brandBlue, textDecoration: 'none', fontWeight: 'bold' }}
            >
              Register
            </Link>
          </Box>
